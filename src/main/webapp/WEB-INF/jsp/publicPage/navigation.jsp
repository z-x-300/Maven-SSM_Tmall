...
<nav id="nav">
	<a href="${pageContext.request.contextPath}/index.jsp">
        ...
        href="${pageContext.request.contextPath}/WEB-INF/jsp/anotherPage/login.jsp" id="loginA">
		<div class="left" id="login">请登录</div>
	</a> <a href="${pageContext.request.contextPath}/WEB-INF/jsp/anotherPage/register.jsp" id="logout">
